			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "parent":
						...
						break;
					case "parentInternal":
					reader.SetPrivateProperty("parentInternal", reader.Read<UnityEngine.Transform>(), instance);
					break;
					case "hasChanged":
					...
					reader.SetPrivateProperty("constrainProportionsScale", reader.Read<System.Boolean>(), instance);
					break;
					default:
						reader.Skip();
						break;
